...
export default function BeeCrest({
  ...
  return (
    <span
      className="bee-crest inline-flex shrink-0"
    ...
    >
      ...
      {mark.tier === 'worker' && (
        ...
        >
          ...
          <path
            d="M16.5 11.4 21 14v5.2L16.5 21.8 12 19.2v-5.2l4.5-2.6Z"
            opacity=".55"
          />
        </svg>
      )}
      ...
      {mark.tier === 'forager' && (
        <svg viewBox="0 0 24 24" className="block h-full w-full">
          <path
            d="M12 2.4 20.6 7.3v9.8L12 22.1 3.4 17.1V7.3L12 2.4Z"
            fill="currentColor"
          />
          <path
      ...
      {mark.tier === 'guard' && (
        <svg viewBox="0 0 24 24" className="block h-full w-full">
          <path
            ...
            fill="currentColor"
          />
          <path d="M12 7 16.4 9.5v5L12 17l-4.4-2.5v-5L12 7Z" fill="#fff" />
        </svg>
      )}
        ...
        <svg viewBox="0 0 24 24" className="block h-full w-full">
          <defs>
            <linearGradient id="bee-royal-grad" x1="0" y1="0" x2="1" y2="1">
              ...
              <stop offset="1" stopColor="#a73afd" />
            </linearGradient>
          </defs>
          <path
