...
// Aceternity UI — copied verbatim from https://ui.aceternity.com (registry: floating-navbar).
...
export const FloatingNav = ({
  navItems,
  className,
  // Local adaptation: the registry hardcodes a "Login" button; the website
  // needs a configurable call-to-action link in the same slot.
  cta,
}: {
  navItems: {
    name: string;
